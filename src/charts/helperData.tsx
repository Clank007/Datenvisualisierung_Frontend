...
export const schwundfaktorDaten : SchwundfaktorFormat[] = [
    ...
    new SchwundfaktorFormat( "IFI-dual", [2020, 2021, 2022, 2023, 2024], [ 1.1000, 1.0500, 1.0500, 1.0495, 1.0759]),
    new SchwundfaktorFormat( "ISMI B.Sc.", [2020, 2021, 2022, 2023, 2024], [ 1.2691, 1.3697, 1.3311, 1.3369, 1.4181]),
    new SchwundfaktorFormat( "ET B.Eng.", [2020, 2021, 2022, 2023, 2024], [ 1.4887, 1.3836, 1.3187, 1.3193, 1.2803]),
